      ...
      .then(data => {
        //   console.log(data.data.result);
          ...
          for(var i=0;i<this.items.length;i++){
            console.log(this.gps_humi[0])
            this.gps_humi[i] = result[i].gps_humi;
            this.gps_temp1[i]=this.items[i].gps_temp1/10;
            this.gps_temp2[i]=this.items[i].gps_temp2/10;
            this.gps_temp3[i]=this.items[i].gps_temp3/10;
